...
<div class="kelpie_painel">
	...
	<div class="kelpie_sidebar">
		<ul class="nav nav-list">
			...
			<li class="active"><a href="index.php?option=com_kelpie&view=videos">Videos</a></li>
			<li ><a href="index.php?option=com_kelpie&view=players">Players</a></li>

		</ul>
	</div>
	<div class="kelpie_content">
		<form action="index.php?option=com_kelpie&view=videos" method="post" id="adminForm" name="adminForm">
	<div class="row-fluid">
		<div class="span6">
	...
	<table class="table table-striped table-hover">
		...
		<tr>
			...
			<th width="2%">
				<?php echo JHtml::_('grid.sort', 'COM_KELPIE_VIDEOS_VOTES', 'id', $listDirn, $listOrder); ?>
		...
		<tbody>
			<?php if (!empty($this->items)) : ?>
				<?php foreach ($this->items as $i => $row) :
					$link = JRoute::_('index.php?option=com_kelpie&task=video.edit&id=' . $row->id);
				?>
					<tr>
