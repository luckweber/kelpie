...
<div class="kelpie_painel">
	...
	<div class="kelpie_sidebar">
		<ul class="nav nav-list">
			...
			<li class="active"><a href="index.php?option=com_kelpie&view=players">Players</a></li>
		</ul>
	</div>
	<div class="kelpie_content">
		<form action="index.php?option=com_kelpie&view=players" method="post" id="adminForm" name="adminForm">
	<div class="row-fluid">
		<div class="span6">
		...
		<tbody>
			<?php if (!empty($this->items)) : ?>
				<?php foreach ($this->items as $i => $row) :
					$link = JRoute::_('index.php?option=com_kelpie&task=player.edit&id=' . $row->id);
				?>
					<tr>
						...
						<td align="center">
							<?php echo JHtml::_('jgrid.published', $row->published, $i, 'players.', true, 'cb'); ; ?>
						</td>
						<td align="center">
							<?php echo $row->id; ?>
						</td>
